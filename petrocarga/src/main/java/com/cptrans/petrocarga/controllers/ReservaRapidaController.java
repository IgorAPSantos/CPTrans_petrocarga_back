...
// TODO: Refatorar ReservaRapidaController
...
//         Vaga vaga = vagaService.findById(reservaRapidaRequestDTO.getVagaId());
//         Agente agente = agenteService.findById(reservaRapidaRequestDTO.getAgenteId());

//         ReservaRapida reservaRapida = reservaRapidaRequestDTO.toEntity(vaga, agente);
...
//         // 3. Todas as verificações passaram, realizar a atualização
//         ReservaRapida existingReservaRapida = existingOpt.get();
//         existingReservaRapida.setVaga(vaga);
//         existingReservaRapida.setAgente(agente);
